...
export default function CostAndRule() {
  ...
  return (
    <section ref={sectionRef} id="cost" className="relative px-4 py-24">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2 md:items-start">
          ...
          <div className="cost-card paper-index relative rounded-lg border-[3px] border-saigon p-6 pt-14 shadow-[0_8px_0_#cbd8ee] md:p-8 md:pt-14">
          ...
          <div className="cost-card relative rounded-2xl border-4 border-saigon bg-white p-6 pt-9 shadow-[0_8px_0_#01337f] md:p-8 md:pt-10">
